...
(async () => {
  ...
  if (aboutSec) {
    ...
    await page.screenshot({ path: path.join(artifactsDir, 'restored_about_background.png') });
    console.log('Captured restored_about_background.png');
  }
  ...
  if (techSec) {
    ...
    const artifactsDir = 'C:\\Users\\Yasser\\.gemini\\antigravity\\brain\\8433bbcd-561c-4d52-bb5b-fc92c068f5ee';
    await page.screenshot({ path: path.join(artifactsDir, 'restored_tech_specs.png') });
    console.log('Captured restored_tech_specs.png');
  }
